...
export function useQuotations() {
  ...
  // exactly as it was when coming back from a quotation page.
  ...
  const filters: ValuesFilterQuotations = useMemo(() => {
    const result: any = { ...initialFilters };
    quotationFilterKeys.forEach((key) => {
